...
export function SystemOverview({ summary }: { summary: SystemSummary }) {
  const metrics = [
    ...
    },
    {
      label: "Memory",
      value:
        summary.memory.used_percent !== null
    ...
    },
    {
      label: "Disk",
      value:
        summary.disk.used_percent !== null
    ...
    {
      label: "Uptime",
      value: summary.uptime_label ?? "Unavailable",
      note: summary.temperature_c !== null ? `${summary.temperature_c}C` : "Temp unavailable",
      icon: <TimerReset className="h-4 w-4 text-accent/80" />,
    },
  ];
